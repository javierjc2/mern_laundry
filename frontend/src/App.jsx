...
const ProtectedRoute = ({ children, adminOnly = false }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-[#4D6F71] to-[#365456] flex items-center justify-center text-white font-sans text-xl font-medium animate-pulse">
        Loading...
      </div>
    );
  }
